...
<!-- Edited 16. April 2018 SM -->
<!--<xsl:param name="body.font.family" select="$serif-stack"/>-->
<xsl:param name="body.font.family">&stafford;</xsl:param>
...
<xsl:param name="title.font.family">&arezzo;</xsl:param>
...
<xsl:param name="suse.doc.url">http://saigkill.tuxfamily.org/documentation</xsl:param>

<!-- SUSE  -->
<xsl:param name="company.address">Sascha Manns
Maifeldstraße 10
56727 Mayen
Germany</xsl:param>

<xsl:param name="metadata.producer">Sascha Manns, Mayen</xsl:param>
<xsl:param name="glossary.sort">1</xsl:param>
  
<xsl:param name="title.color">&manns;</xsl:param>
<xsl:param name="title1.color">&manns1;</xsl:param>
<xsl:param name="title2.color">&manns2;</xsl:param>
<xsl:param name="title3.color">&manns3;</xsl:param>
<xsl:param name="title4.color">&manns4;</xsl:param>
