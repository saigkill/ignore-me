...
<xsl:attribute-set name="section.title.level2.properties">
  <xsl:attribute name="color"><xsl:value-of select="$title1.color"/></xsl:attribute>
  <xsl:attribute name="font-size"><xsl:value-of select="&xx-large; * $sans-fontsize-adjust"/>pt</xsl:attribute>
</xsl:attribute-set>
<xsl:attribute-set name="section.title.level3.properties">
  <xsl:attribute name="color"><xsl:value-of select="$title2.color"/></xsl:attribute>
  <xsl:attribute name="font-size"><xsl:value-of select="&x-large; * $sans-fontsize-adjust"/>pt</xsl:attribute>
</xsl:attribute-set>
<xsl:attribute-set name="section.title.level4.properties"
  use-attribute-sets="sans.bold.noreplacement">
  <xsl:attribute name="color"><xsl:value-of select="$title3.color"/></xsl:attribute>
  <xsl:attribute name="font-size"><xsl:value-of select="&large; * $sans-fontsize-adjust"/>pt</xsl:attribute>
</xsl:attribute-set>
<xsl:attribute-set name="section.title.level5.properties">
  <xsl:attribute name="color"><xsl:value-of select="$title4.color"/></xsl:attribute>
  <xsl:attribute name="font-size"><xsl:value-of select="&large; * $sans-fontsize-adjust"/>pt</xsl:attribute>
</xsl:attribute-set>
...
<xsl:attribute-set name="title.name.color">
  <xsl:attribute name="color">&manns;</xsl:attribute>
</xsl:attribute-set>
...
<xsl:param name="dark-green">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>&manns;</xsl:otherwise>
  </xsl:choose>
</xsl:param>
